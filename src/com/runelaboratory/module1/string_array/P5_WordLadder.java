...
public class P5_WordLadder {
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        System.out.println("solution2 : " + solution(start2, end2, new HashSet<>(disc2)));
        System.out.println("answer2 : " + answer(start2, end2, new HashSet<>(disc2)));

        String start3 = "abcv";
        String end3 = "ebad";
        Set<String> disc3 = new HashSet<>(Arrays.asList("abcd", "ebad", "ebcd", "xyza"));
        System.out.println("solution3 : " + solution(start3, end3, new HashSet<>(disc3)));
        System.out.println("answer3 : " + answer(start3, end3, new HashSet<>(disc3)));

        String start4 = "fool";
        String end4 = "sage";
        Set<String> disc4 = new HashSet<>(Arrays.asList("fool", "pool", "poll", "pole", "pale", "sale", "sage"));
        System.out.println("solution4 : " + solution(start4, end4, new HashSet<>(disc4)));
        System.out.println("answer4 : " + answer(start4, end4, new HashSet<>(disc4)));

        String start5 = "der";
        String end5 = "dfs";
        Set<String> disc5 = new HashSet<>(Arrays.asList("des","der","dfr","dgt","dfs"));
        System.out.println("solution5 : " + solution(start5, end5, new HashSet<>(disc5)));
        System.out.println("answer5 : " + answer(start5, end5, new HashSet<>(disc5)));

        String start6 = "gedk";
        String end6 = "geek";
        Set<String> disc6 = new HashSet<>(Arrays.asList("geek", "gefk"));
        System.out.println("solution6 : " + solution(start6, end6, new HashSet<>(disc6)));
        System.out.println("answer6 : " + answer(start6, end6, new HashSet<>(disc6)));
    }
